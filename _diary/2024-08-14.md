...
| --------------- | ------------------------------------------------------------------------ | ------------------------------------------ |
| Domain          | Problem Space, Concept / Rule<br>Expnain by Business-Meaning Terminology | Entity, Value<br>Aggregate, Aggregate Root |
| Domain Model    | Relationship between Domain Objects                                      |                                            |
| Bounded Context | as Actor<br>- Customer, Seller, Admin, ...                               |                                            |
