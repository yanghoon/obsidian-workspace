...
| ==Bounded Context== | Exclusive Problem Space<br>- as Actor (Customer, Seller, Admin, ...)              |                                                                   |
| ==Sub-domain==      | Seperated Bounded Context<br>- Aggregate Root (Order, Payment, Product Recommend) |                                                                   |
#### References
